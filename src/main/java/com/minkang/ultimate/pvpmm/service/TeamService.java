...
public class TeamService {
    ...
    public void clearWholeTeam(java.util.UUID uid){
        Integer id=playerTeamId.get(uid); if(id==null) return;
        Set<java.util.UUID> mem=teamMembers.remove(id);
        if(mem!=null) for(java.util.UUID u: mem) playerTeamId.remove(u);
    }
}
