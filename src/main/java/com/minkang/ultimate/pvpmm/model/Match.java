...
public class Match {
    ...
    public void setStartMillis(long m){ startMillis=m; }
    public String getScoreboardTeamA(){ return scoreboardTeamA; }
    public void setScoreboardTeamA(String s){ scoreboardTeamA=s; }
    public String getScoreboardTeamB(){ return scoreboardTeamB; }
    public void setScoreboardTeamB(String s){ scoreboardTeamB=s; }
