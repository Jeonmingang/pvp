...
public class ArenaManager {
    ...
    public void save() {
        ...
        for (Arena arena : arenas.values()) {
            ...
            cfg.set(base + ".pos1", LocationUtil.serialize(arena.getPos1()));
            cfg.set(base + ".pos2", LocationUtil.serialize(arena.getPos2()));
            cfg.set(base + ".pos3", LocationUtil.serialize(arena.getPos3()));
            cfg.set(base + ".pos4", LocationUtil.serialize(arena.getPos4()));
        }
        try {
            cfg.save(file);
        } catch (IOException e) {
